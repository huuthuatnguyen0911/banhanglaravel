                    ...
                    <form action="{{url('/assign-roles')}}" method="POST">
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <p><a class="btn btn-sm btn-danger" href="{{url('/delete-user-roles/'.$user->admin_id)}}">Xoá user</a></p>
                                <p><a class="btn btn-sm btn-success" href="{{url('/impersonate/'.$user->admin_id)}}">Chuyển quyền</a></p>
                            </td>

    ...
    <header class="header-v4">
            ...
            <div class="wrap-menu-desktop how-shadow1">
                <nav class="limiter-menu-desktop container">
                    ...
                    <a href="{{URL::to('/trang-chu')}}" class="logo">
                        <img src="{{asset('public/frontend/images/icons/logo_03.jpg')}}" alt="IMG-LOGO">
                    </a>
                    ...
                    <div class="menu-desktop">
                        <ul class="main-menu">
                            ...
                            <li>
                                <a href="{{URL::to('/lien-he')}}">Contact</a>
                            </li>
                        </ul>
                    </div>
        ...
        <div class="wrap-header-mobile">
            ...
            <div class="logo-mobile">
                <a href="{{URL::to('/trang-chu')}}"><img src="{{asset('public/frontend/images/icons/logo_03.jpg')}}" alt="IMG-LOGO"></a>
            </div>
    ...
    <script type="text/javascript">
        function Huydonhang(id){
            ...
            success: function(data) {
                alert('Đơn hàng của bạn đang được xem xét hủy. Chúng tôi sẽ phản hồi lại bạn trong thời gian sớm nhất !!!');
                location.reload();
            }
